      ...
      <div className="modal-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="dias_promocion" className="form-label">Duración de la Promoción (días) <span style={{ color: '#ef4444' }}>*</span></label>
              <input type="number" name="dias_promocion" id="dias_promocion" value={formData.dias_promocion} onChange={handleChange} className={`form-input ${errores.dias_promocion ? 'input-error' : ''}`} placeholder="Ej: 30" />
