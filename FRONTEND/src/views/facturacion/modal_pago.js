...
function ModalPago({ show, total, onClose, onSuccess }) {
  ...
  const handlePaymentAmountChange = (methodId, value) => {
    ...
    // Si hay dos métodos, ajusta automáticamente el otro
          ...
          <>
            ...
            <div className="overflow-y-auto max-h-[calc(90vh-140px)]">
              <div className="p-4 space-y-4">
                ...
                {/* Métodos */}
                <div>
                  <p className="text-sm font-medium text-gray-700 mb-2">Seleccione método(s)</p>
                ...
                {selectedPaymentMethods.length > 0 && (
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-2">Ingrese montos</p>
                    <div className="space-y-2">
