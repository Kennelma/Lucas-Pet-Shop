...
const ModalActualizarRecordatorio = ({
  ...
  const handleActualizar = async () => {
    ...
    const fechaFormateada = fechaProgramacion + ":00"; // "2025-11-17T14:30:00"

    const payload = {
      id_recordatorio: recordatorio.id_recordatorio_pk,
      mensaje_recordatorio: mensaje.trim(),
      programada_para: fechaFormateada, 
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          ...
          >
            ...
            {frecuencias.map((f) => (
              <option
                key={f.id_frecuencia_record_pk}
                value={f.id_frecuencia_record_pk}
              >
