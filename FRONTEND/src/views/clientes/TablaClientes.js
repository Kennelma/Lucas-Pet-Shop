...
import { insertarRegistro, verRegistro } from "../../services/apiService.js"; 
...
const TablaClientes = ({
  ...
  useEffect(() => {
    const fetchClientes = async () => {
      const datos = await verRegistro("tbl_clientes"); // llama al endpoint GET
      setClientes(datos); // actualiza el estado de clientes
    };
    fetchClientes();
  }, []);
