...
const ActionMenu = ({ rowData, onEditar, onEliminar, rowIndex, totalRows }) => {
  ...
  return (
    <div className="relative flex justify-center" ref={menuRef}>
      ...
      {isOpen && (
        <div className={`absolute right-0 ${shouldShowAbove ? 'bottom-full mb-1' : 'top-full mt-1'} bg-white border border-gray-200 rounded-lg shadow-lg z-[9999] min-w-[140px] text-xs sm:text-sm`}>
          <div
            ...
            <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6 font-poppins border-2" style={{borderColor: '#B5DD7E'}}>
                ...
                {clientes.length === 0 && !loading ? (
                    ...
                    >
                        ...
                        <Column header="ACCIONES" body={actionBotones} className="text-xs sm:text-sm text-center px-2" style={{ width: '70px', minWidth: '70px', overflow: 'visible' }} />
                    </DataTable>
                    </div>
                )}
            </div>
