          ...
          <div className="flex justify-center mb-6">
            <div className="flex flex-wrap rounded-lg bg-gray-200 p-1 w-80 text-sm shadow-sm">
              <label className="flex-1 text-center">
                ...
                />
                <span
                  className={`flex items-center justify-center gap-2 rounded-lg py-2 px-4 cursor-pointer transition-all duration-150 ${pestanaActiva === 'reportes'
              ...
              <label className="flex-1 text-center">
                ...
                />
                <span
                  className={`flex items-center justify-center gap-2 rounded-lg py-2 px-4 cursor-pointer transition-all duration-150 ${pestanaActiva === 'tabla'
                      ? 'bg-white font-semibold text-gray-800 shadow-sm'
                      : 'text-gray-600 hover:text-gray-800'
                    }`}
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-around gap-4 md:gap-8">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className={`text-xl font-bold ${saldoDiario >= 0 ? 'text-blue-700' : 'text-orange-700'}`}>
