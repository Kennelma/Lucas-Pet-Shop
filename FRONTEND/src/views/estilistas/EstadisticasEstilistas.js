  ...
  return (
    <div className="mb-3">
      <div className="max-w-7xl mx-auto">
        ...
        {/*FILTROS_DE_FECHA*/}
        <div className="bg-gray-100 rounded-lg p-4 mb-6" style={{boxShadow: '0 0 8px #F8E6A440, 0 0 0 1px #F8E6A433'}}>
          <div className="flex flex-col sm:flex-row gap-3 items-center justify-center">
            ...
            <input
              ...
              className="px-3 py-2 border border-white-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
