...
class WAConnection extends events_1.EventEmitter {
     ...
     */
    async waitForMessage(tag, json, timeoutMs) {
        try {
            const result = await Utils.promiseTimeout(timeoutMs, (resolve, reject) => (this.callbacks[tag] = { queryJSON: json, callback: resolve, errCallback: reject }));
            return result;
        }
        finally {
    ...
    endConnection() {
        ...
        try {
            ...
            (_f = this.conn) === null || _f === void 0 ? void 0 : _f.terminate();
        }
        catch (_g) {
        }
        this.conn = null;
