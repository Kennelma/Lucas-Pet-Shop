...
exports.crearFactura = async (req, res) => {
    ...
    try {
        ...
        console.log('🔍 DEBUG BACKEND - id_cliente:', id_cliente);
        console.log('🔍 DEBUG BACKEND - nombre_cliente:', nombre_cliente);
        ...
        console.log('🔍 DEBUG - Antes de INSERT:', { id_cliente, nombre_cliente });
